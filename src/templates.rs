...
pub fn get_templates() -> HashMap<String, AccountTemplate> {
    ...
    templates.insert("github".to_string(), AccountTemplate {
    ...
    templates.insert("gitlab".to_string(), AccountTemplate {
    ...
    templates.insert("bitbucket".to_string(), AccountTemplate {
    ...
    templates.insert("azure".to_string(), AccountTemplate {
